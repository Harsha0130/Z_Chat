package com.example.zchat.adapter;
...
import com.example.zchat.ChatActivity;
import com.example.zchat.R;
                ...
                .get().addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        holder.itemView.setOnClickListener(v ->{
                            ...
                            AndroidUtil.passUserModeelAsIntent(intent, otherUserModel);
